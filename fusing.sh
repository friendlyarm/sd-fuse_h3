...
if [ $# -eq 0 ]; then
	echo "Usage: $0 DEVICE <ubuntu-noble-core | friendlycore-jammy | friendlycore-focal | debian-trixie-core | debian-bookworm-core | debian-jessie | friendlycore | friendlywrt | eflasher>"
	exit 0
fi
...
case ${TARGET_OS} in
ubuntu-noble-core | friendlycore-focal | friendlycore-jammy | debian-trixie-core | debian-bookworm-core | debian-jessie | friendlycore | friendlywrt | eflasher)
        ;;
*)
