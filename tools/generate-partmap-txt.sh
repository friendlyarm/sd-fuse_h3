...
{
    declare -a platfroms=("s5p4418" "s5p6818" "rk3399" "h3" "h5")
    declare -a rootfs_partition_address=(0x4400000 0x4400000 0x6000000 0x4000000 0x7C00000)
    ...
    if [ ${FOUND} == 0 ]; then
        echo "${0} only support [s5p4418/s5p6818/rk3399/h3/h5]"
        exit 1
    fi
